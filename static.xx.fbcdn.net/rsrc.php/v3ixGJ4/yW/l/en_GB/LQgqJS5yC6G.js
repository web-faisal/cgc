...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var i = {
      ...
      render: function () {
        if (!(h || (h = b("ExecutionEnvironment"))).canUseDOM) return null;
    ...
    a = {
      createClass: function (a) {
        return b("createReactClass_DEPRECATED")({ mixins: [i, a] });
      },
    };
    e.exports = a;
  },
      ...
      d.render = function () {
        ...
        this.props.customButton
          ...
          : b[0] &&
            c("DangerouslyAccessReactElementInternals_DO_NOT_USE_IN_NEW_CODE")(
              b[0]
            ).type === c("XUISelectorButton.react")
          ? ((a = b[0]), (b = b.slice(1)))
              ...
              var l =
                ...
                a instanceof c("FbtResultBase")
                  ? {
                      body: a,
                      highlightStay: !1,
                      leaveButtonText: h._("Leave this Page"),
                      showCloseButton: !1,
                      stayButtonText: h._("Stay on This Page"),
                      title: h._("Leave page?"),
                    }
                  : a;
              e = j.jsx(e, {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, e, f) {
      return new (j || (j = b("Promise")))(function (a, b) {
                ...
                j.jsxs(l, {
                  ...
                  children: [
                    ...
                    j.jsx("div", {
                      className: "_18ts",
                      children: h._(
                        "Upon clicking, you will go to an external URL: {url name}",
                        [
                          h._param(
                            "url name",
...
__d(
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    var i = h._("Website"),
      ...
      n = h._("Edit button"),
      o = h._("Delete button"),
      p = h._("Contact Requests"),
      q = h._("Choose a Button"),
      r = h._("Website"),
      s = h._("App"),
      t = h._("ANDROID SETTINGS"),
      u = h._("IOS SETTINGS"),
      v = h._("Choose where to send people on Android"),
      w = h._(
        "Now that you've added this button to your Facebook Page, you can promote it."
      ),
      x = h._("Add a button to your Page"),
      y = h._("Website"),
      z = h._("Example: {url}", [h._param("url", "http://www.mywebsite.com")]),
      A = h._("Set up a link to an app?"),
      B = h._("Visitors using iOS will be sent to the website above."),
      C = h._("Visitors using Android will be sent to the website above."),
      D = h._("Visitors using iOS will be sent to the app link entered below."),
      E = h._(
        "Visitors using Android will be sent to the app link entered below."
      ),
      F = h._("Choose where to send people on iOS"),
      G = h._("iOS App Deep Link"),
      H = h._("Android App Deep Link"),
      I = h._("Website or App Store link"),
      J = h._("Website or Play Store link"),
      K = h._(
        "If you like, you can set up app deep links for iOS or Android users. This is only necessary if you have an app that you want to send visitors to."
      ),
      L = h._(
        "Add a button to your Page that takes people directly to your website or app."
      ),
      M = h._("Edit Promotion"),
      N = h._("View promotion"),
      O = h._("Promote"),
      P = h._("Not Now"),
      Q = h._("Learn more"),
      R = h._("Deep link"),
      S = h._("We will open the app selected above if installed"),
      T = h._("People who don't have your app will be sent here."),
      U = h._("Package name"),
      V = h._("Add the Android package name of your app."),
      W = h._(
        "Send people to a specific place inside your app, such as a product page."
      ),
      X = h._("We will open the app selected above if installed"),
      Y = h._("We will use the package name from the selected app"),
      Z = h._(
        "Do you really want to delete this button from your Facebook Page?"
      );
    d = h._(
      "This will remove the Get Quote button from your Page. {new_line} Your automated questions will also be turned off and won't be sent to people who message you.",
      [h._param("new_line", d.jsx("div", { children: d.jsx("br", {}) }))]
    );
    var $ = h._("Add a Button"),
      aa = h._(
        "Add a button to get people to take an action from your Page, such as shop or sign up"
      ),
      ba = h._(
        "Finish setting up your button so that people can take this action from your Page."
      ),
      ca = h._("Changing the button will end your ad"),
      da = h._("The button can't be changed at the moment"),
      ea = h._("Phone number"),
      fa = h._("Email address"),
      ga = h._("Example: 8005550199"),
      ha = h._("Add an email address"),
      ia = h._("Date:"),
      ja = h._("Time:"),
      ka = h._("Party Size:"),
      la = h._("What information would you like to collect?"),
      ma = h._(
        "Some text here that explains that this contact information will expire 90 days after it has been submitted."
      ),
      na = h._("Add a link to your Privacy Policy"),
      oa = h._(
        "An explanation of your privacy policy and why it is required. Let people know why this is important."
      ),
      pa = h._("Phone Number and Email Address"),
      qa = h._("Phone Number"),
      ra = h._("Email"),
      sa = h._(
        "This feature is designed to permit response to inbound requests from individuals. Depending on your country, certain types of contact may require additional consents required by law. You agree that you are responsible for obtaining those consents and complying with our"
      ),
      ta = h._("Send people to an app or website"),
      ua = h._("Add a comment"),
      va = h._("Enter your name"),
      wa = h._("Enter your email address"),
      xa = h._("Phone Number"),
      ya = h._("OK"),
      za = h._("Yes"),
      Aa = h._("No"),
      Ba = h._(
        "By creating this Call to Action button, you certify that both of the following statements are true and accurate:"
      ),
      Ca = h._(
        "Your organisation operates as a charitable organisation under the applicable laws in your jurisdiction. US-based organisations must be organised and operating pursuant to section 501 (c) (3) of the US Internal Revenue Code, even if you have not yet applied."
      ),
      Da = h._(
        "Your organisation does not directly or indirectly intervene in any political campaign on behalf of or in opposition to any candidates for public office."
      ),
      Ea = h._("Mark as Responded"),
      Fa = h._("Ban from Page"),
      Ga = h._("Shop Now will link to the shop section of your Page."),
      Ha = h._("See Offers will link to your Page's offer section."),
      Ia = h._("Let people request an appointment without leaving your Page."),
      Ja = h._("Make it easy for customers to buy tickets from your Page."),
      Ka = h._("Get Tickets will link to the events section of your Page."),
      La = h._(
        "Donate allows your supporters to donate to your organisation directly through Facebook."
      ),
      Ma = h._("Processing video..."),
      Na = h._("Preview"),
      Oa = h._("Uploading video..."),
      Pa = h._("Preparing video..."),
      Qa = h._("Mark as Complete"),
      Ra = h._("Mark as Incomplete"),
      Sa = h._("Organic"),
      Ta = h._("Paid"),
      Ua = h._("Clicks this week"),
      Va = h._("Edit button on location Pages");
    function a(a) {
      return h._("Delete {Page button label} button", [
        h._param("Page button label", a),
      ]);
    }
    a.displayName = a.name + " [from " + f.id + "]";
    function b(a) {
      return h._("Promote {Page button label} Button", [
        h._param("Page button label", a),
      ]);
    }
    b.displayName = b.name + " [from " + f.id + "]";
    function c(a) {
      return h._("Edit {CTA label} button", [h._param("CTA label", a)]);
    }
    c.displayName = c.name + " [from " + f.id + "]";
    function e(a) {
      return h._("Disconnect from Application ({app id})", [
        h._param("app id", a),
      ]);
    }
    ...
    a = (function (a) {
      ...
      d.$11 = function () {
        ...
        this.state.availableTimes.length ||
          (c = j.jsx("div", { children: h._("No tables match your search") }));
        ...
        return j.jsxs("span", {
          children: [
            j.jsx("div", {
              children: h._(
                "Table for {party size for reservation}, {date for reservation} at around {time for reservations}",
                [
...
__d(
  ...
  function (a, b, c, d, e, f) {
    e.exports = b("XController").create("/login/", {
      ...
      custom_content_config: { type: "Enum", enumType: 1 },
        ...
        switch (this.props.destinationType) {
          ...
          case "WEBSITE":
            ...
            if (this.props.redirect) {
              c = b("ThisControllerNoLongerExists").__DEADURI__("3g93goei");
