...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    var h = c("requireDeferredForDisplay")(
      ...
      k =
        (e = c("AnalyticsCoreData").max_delay_br_queue_immediate) != null
          ...
          : 1e3;
    b =
      (f = c("AnalyticsCoreData").max_delay_br_init_not_complete) != null
        ? f
        : 1e3;
    var l = "falco:",
      m = new (c("Queue"))(),
      ...
      t = new Set(),
      u =
        (e = c("FalcoAppUniverse").cast(c("AnalyticsCoreData").app_universe)) !=
        null
          ? e
          : 1,
      v = [],
    ...
    for (
      e =
        (f = c("AnalyticsCoreData").stateful_events_list_for_br) != null
          ? f
          : [],
        b = Array.isArray(e),
        f = 0,
    ...
    for (
      f =
        (H = c("AnalyticsCoreData").stateless_non_fb_events_for_br) != null
          ? H
          : [],
        b = Array.isArray(f),
        e = 0,
    ...
    function J(a, b) {
      R(b.item.name, "js.br.add_to_batch", 1, !0);
      var c = b.item.extra.length;
      w + c > i && (clearTimeout(x), K());
      v.push([a, b]);
      w += c;
    }
    function K() {
      ...
      if (!C) {
        Q("js.br.init_not_complete.log", a.length);
        var b = function () {
          var b = a[c],
            d = b[0],
            e = b[1];
          R(e.item.name, "js.br.banzai_fallback_for_init_not_complete", 1, !0);
          ((b = e.item.logImmediate) != null ? b : !1)
            ? S.logImmediately([e.item], function (a) {
                return d.markItem(e, a);
              })
            : S.log([e.item], function (a) {
                return d.markItem(e, a);
              });
        };
        ...
        m.enqueue(function (b) {
          return b.log(
            ...
            function (b) {
              if (!b) {
                Q("js.br.banzai_fallback", a.length);
                var c = function () {
                  var c = a[d],
                    b = c[0],
                    e = c[1];
                  R(e.item.name, "js.br.banzai_fallback_for_failure", 1, !0);
    ...
    function M(a) {
      ...
      a.identity = N(c("AnalyticsCoreData").identity);
    ...
    function O(a, b) {
      for (var e = 0; e < a.length; e++) {
        var f,
          g = a[e];
        R(g.name, "js.banzai.posting_event", 1, !1);
        f =
          ((f = {}),
          (f.e = g.extra),
          (f.r = g.policy.r),
      ...
      P("planes.banzai.write_to_transport", a);
    }
    function P(a, b) {
      var c = 0;
      for (var d = 0; d < b.length; d++) {
    ...
    var S = {
      log: function (a, b) {
        P("js.banzai.post.log", a), O(a, c("Banzai").BASIC), b(!0);
      },
      logImmediately: function (a, b) {
        P("js.banzai.post.log_immediately", a), O(a, c("Banzai").VITAL), b(!0);
      },
      logCritical: function (a, b) {
        P("js.banzai.post.log_critical", a),
          O(a, { signal: !0, retry: !0 }),
          b(!0);
      },
    };
    function T(a) {
      Y();
      var b = U(a, "banzai_data_loss", "log"),
        d = U(a, "banzai_data_loss", "logImmediately"),
        e = U(a, "banzai_data_loss", "logCritical"),
        f = U(a, "bladerunner_data_loss", ""),
        g = U(a, "bladerunner_data_loss", "logCritical");
      Q("js.br_data_loss.posted." + a, 1);
      if (C && B)
        try {
          m.enqueue(function (b) {
            return b.log([f], function (b) {
              if (!b) {
                Q("js.br.transport_failure." + a, 1);
                S.logCritical([g], function (b) {
                  Q("js.br.failure_fallback_success_callback." + a, 1);
                });
                return;
              }
              Q("js.br.success_callback." + a, 1);
            });
          });
        } catch (b) {
          Q("js.br.error_enqueueing." + a, 1),
            S.logCritical([g], function (b) {
              Q("js.br.enqueuing_fallback_success_callback." + a, 1);
            });
        }
      else
        B || Q("js.br.failed." + a, 1),
          C || Q("js.br.init_not_complete." + a, 1),
          S.logCritical([g], function (b) {
            Q("js.br.init_fallback_success_callback." + a, 1);
          });
      O([b], c("Banzai").BASIC);
      O([d], c("Banzai").VITAL);
      O([e], { signal: !0, retry: !0 });
    }
    function U(a, b, d) {
      return {
        name: b,
    ...
    function X(a) {
      m.start(function (b) {
        return b({
          log: function (d, b) {
            P("planes.bladerunner.write_to_transport", d);
            var e = JSON.stringify(L(d));
            a
              ? c("AnalyticsCoreData").enable_ack
                ? c("promiseDone")(
                    a.amendWithAck(e),
                    function (a) {
                      P("planes.bladerunner.ack_received" + a.toString(), d),
                        b(a);
                    },
                    function () {
                      P("planes.bladerunner.ack_failure", d), b(!1);
                    }
                  )
                : (a.amendWithoutAck(e),
                  P("planes.bladerunner.write_without_ack", d))
              : (P("planes.bladerunner.request_stream_null", d), b(!1));
          },
      ...
      h.onReady(function (a) {
        ...
        c("promiseDone")(
          a
            .requestStream(
              { method: "Falco" },
              JSON.stringify(M(d("WebSession").getId())),
              b,
              { requestId: "" }
            )
            .then(function (b) {
    ...
    function Z(a) {
      ...
      return u !== 1 &&
        c("AnalyticsCoreData").enable_non_fb_br_stateless_by_default !== !0 &&
        !t.has(b)
        ? !1
        : a.policy.s === 1;
    }
    ...
    function a() {
      ...
      c("PersistedQueue").setHandler("falco_queue_log", function (b) {
        ...
        while ((c = b.dequeueItem()))
          (function (c) {
            Z(c.item)
              ? (R(c.item.name, "js.use_bladerunner.log", 1, !0),
                Y(),
                x == null && (x = setTimeout(K, F)),
                e && !a(d) && (c.item.identity = e),
                J(b, c))
              : (R(c.item.name, "js.use_banzai.log", 1, !0),
                e && (c.item.identity = e),
                S.log([c.item], function (a) {
      ...
      c("PersistedQueue").setHandler("falco_queue_immediately", function (b) {
        ...
        while ((d = b.dequeueItem()))
          (function (d) {
            Z(d.item)
              ? (R(d.item.name, "js.use_bladerunner.log_immediately", 1, !0),
                Y(),
                (x == null || !y) &&
                  (clearTimeout(x), (x = setTimeout(K, G)), (y = !0)),
                ...
                c("PersistedQueue").isPersistenceAllowed() ||
                  ...
                  K()))
              : (R(d.item.name, "js.use_banzai.log_immediately", 1, !0),
                f && (d.item.identity = f),
                S.logImmediately([d.item], function (a) {
      ...
      c("PersistedQueue").setHandler("falco_queue_critical", function (b) {
        ...
        while ((c = b.dequeueItem()))
          (function (c) {
            var f = c.item;
            Z(f)
              ? (R(f.name, "js.use_bladerunner.log_critical", 1, !0),
                Y(),
                !C
                  ? (R(f.name, "js.br.init_not_complete.logCritical", 1, !0),
                    e && (f.identity = e),
                    S.logCritical([f], function (a) {
                      return b.markItem(c, a);
                    }))
                  : (e && !a(d) && (f.identity = e),
                    m.enqueue(function (a) {
                      return a.logCritical([f], function (a) {
                        if (!a) {
                          Q("js.br.banzai_fallback.critical", 1);
                          R(
                            c.item.name,
              ...
              : (e && (f.identity = e),
                R(f.name, "js.use_banzai.log_critical", 1, !0),
                S.logCritical([f], function (a) {
                  return b.markItem(c, a);
                }));
          })(c);
      });
      c("AnalyticsCoreData").enable_dataloss_timer && (Y(), V(), W());
      function a(a) {
        try {
