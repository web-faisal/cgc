...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h,
      i = new (c("BootloaderRetryTracker"))({
        retries:
    ...
    function o(e, f) {
      ...
      g[e] = "fetching";
      return (f.includes(m) ? (h || (h = b("Promise"))).resolve(n(f)) : l(f))
        .then(function (b) {
  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    function aa(a, b, e, f) {
      ...
      if (
        ...
        g.forEach(function (b, c) {
          b !== d("CSRIndexUtil").UNKNOWN_RESOURCE_INDEX && t.get(b) !== a
            ? i.add(c)
            : b > j && (j = b);
        });
        j > c("BootloaderConfig").btCutoffIndex &&
          d("BootloaderEvents").notifyResourceInLongTailBTManifest(
            R(g, b.src, i, c("BootloaderConfig").btCutoffIndex),
            f
          );
        if (i.size === g.length) return;
          ...
          i.size > 0 &&
            ...
            b.type === "js" &&
              b.tsrc != null &&
              b.tsrc.trim() !== "" &&
              (b.tsrc = S(c("nullthrows")(b.tsrc), i)));
      }
      b.type === "js" &&
        b.tsrc != null &&
        b.tsrc.trim() !== "" &&
    ...
    function T(a, c, e, f, g) {
      ...
      for (
        ...
        switch (p.type) {
          case "css":
            r = p.nonblocking ? "nonblocking" : "blocking";
            break;
          case "js":
            r = "default";
            break;
          case "async":
            r = p.blocking ? "blocking" : "nonblocking";
            break;
          default:
            p.type, h(0, 3721);
        }
        ...
        var s = A.rsrcDone(q);
        l.push(s);
        r !== "nonblocking" && (k.push(s), r === "blocking" && g.push(s));
        n.has(q) || i.set(q, p);
      }
      var t, u;
      !b("cr:696703")
    ...
    function X(a) {
      ...
      U(e, b, !0);
      n.set(e, c("performanceAbsoluteNow")());
      f = function () {
        return $.done(e);
      };
      g =
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    var h,
      i = d("FalcoUtils").getTaggedBitmap(33),
      j = 500 * 1024 * 0.6,
      k = "ods_web_batch",
      l = new Map(),
      m = new Set([
    ...
    function n(a) {
      var b;
      a.tags = d("FalcoUtils").xorBitmap((b = a.tags) != null ? b : [0, 0], i);
      return a;
    }
    function a(a, b) {
      var d;
      ...
      for (
        ...
        if (l.has(i)) continue;
        g = (
          (g = c("AnalyticsCoreData").use_falco_as_mutex_key) != null ? g : !1
        )
          ...
          : c("PersistedQueue").create(a, { onLoad: n, queueNameSuffix: h });
        l.set(i, g);
      }
      return c("nullthrows")(l.get(a + "^$" + b));
    }
    f = d("FalcoUtils").identityToString(c("AnalyticsCoreData").identity);
    var o = a("falco_queue_log", f),
      p = a("falco_queue_immediately", f),
      q = a("falco_queue_critical", f),
    ...
    function w(a, b) {
      ...
      b != null &&
        ...
        (d = d && x(b, c("AnalyticsCoreData").consents, a));
      return d;
    }
    function x(a, b, d) {
      var e = v[a];
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    "use strict";
    c("Env").defaultTrustedTypesPolicyName ===
