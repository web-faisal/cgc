    ...
    var y = (function () {
      ...
      a.getUribyObject = function (b, d) {
        var e = u(b, d),
          f = h.get(e);
        if (f == null) {
          d && (b.originalRawQuery = o(b.queryParams, b.serializer));
          d = x(b);
      ...
      b.setDomain = function (a) {
        if (Boolean(a)) {
          var b = a.split(".");
          b = b.length >= 3 ? b[0] : "";
          return t(this, { domain: a, subdomain: b });
        }
        return this;
      };
      b.setFragment = function (a) {
        return a === "#"
          ? t(this, { fragment: "", fragmentSeparator: !0 })
          : t(this, { fragment: a, fragmentSeparator: a !== "" });
      };
      b.setPath = function (a) {
        return a != null ? t(this, { path: a }) : this;
      };
      b.setPort = function (a) {
        return Boolean(a) ? t(this, { port: a }) : this;
      };
      b.setProtocol = function (a) {
        return Boolean(a) ? t(this, { protocol: a }) : this;
      };
      ...
      b.setSubDomain = function (a) {
        if (Boolean(a)) {
          ...
          return t(this, { domain: b.join("."), subdomain: a });
        }
        return this;
      };
