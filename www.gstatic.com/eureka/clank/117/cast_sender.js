...
*/
  ...
  var va = Array.prototype.forEach
    ? function (a, b) {
  ...
  var Ya = function (a) {
      ...
      return a.replace(Xa, function (d, e) {
        ...
        if (!g) {
          ...
          if (Wa()) for (; c.lastChild; ) c.removeChild(c.lastChild);
          c.innerHTML = Ta(g);
  ...
  var Ab =
      B("Gecko") &&
      !(-1 != Oa().toLowerCase().indexOf("webkit") && !B("Edge")) &&
      !(B("Trident") || B("MSIE")) &&
      !B("Edge"),
  ...
  var T = function () {
    ...
    U = function (a) {
      ...
      return ("object" == b && a) || "function" == b
        ? "o" +
            ((Object.prototype.hasOwnProperty.call(a, na) && a[na]) ||
              (a[na] = ++oa))
        : b.slice(0, 1) + a;
    };
  f = T.prototype;
  ...
  var X = function (a, b, c, d) {
    ...
    var k = b.dialRequest;
    k &&
      ((e = k.appName), (g = k.launchParameter) && !g.match(Nb) && (g = Gb(g)));
    var l = [];
    l.push({ appId: b.appId, capabilities: b.capabilities });
    b ||
      va(a.g.additionalSessionRequests, function (q) {
  ...
  var Jb = function (a, b) {
    if (a.m) {
      ...
      ub(a.H, c, b) &&
        (a.u.delete(c), a.I.delete(c), (b = a.B.get(c))) &&
        (a.B.delete(c),
        G(b.s(), function (e) {
          e(d);
        }));
